...
namespace AluguelCarros.Controllers
{
    public class EnderecoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Logradouro,Numero,Bairro,Municipio,Uf,Cep")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Logradouro,Numero,Bairro,Municipio,Uf,Cep")] Endereco endereco)
        {
            if (ModelState.IsValid)
            {
